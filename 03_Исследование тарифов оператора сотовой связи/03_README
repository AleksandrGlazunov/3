...
Исследование начинается с **Обзора данных**, который показал, что предоставленные данные готовы к работе.
В **Подготовке данных** были агрегированы израсходованные минуты, сообщения и мегабайты для каждого пользователя за каждый месяц.
При проведении **Исследования данных** были сравнены два тарифа, выявлены основные закономерности в поведении пользователей, сформулированы гипотезы о выручке, которые проверены в **Проверка гипотез**.
