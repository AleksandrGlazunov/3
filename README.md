...
|[07 Определение стоимости автомобилей](https://tinyurl.com/nhhffy9k) | Построение модели определения стоимости автомобиля | `pandas`, `matplotlib`, `seaborn`,  `sklearn`, `PipeLine`, `LinearRegression`, `RandomForestRegressor`, `LGBM`, `CatBoost` | `Машинное обучение`, `Регрессия` |
